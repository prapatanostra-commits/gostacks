...
(define-read-only (ping-6)
  (ok true))
(define-read-only (ping-14) (ok true))
...
(define-read-only (ping-200) (ok true))
...
(define-read-only (ping-164) (ok true))
(define-read-only (ping-172) (ok true))
(define-read-only (ping-16) (ok true))
(define-read-only (ping-22) (ok true))
(define-read-only (ping-122) (ok true))
(define-read-only (ping-125) (ok true))
(define-read-only (ping-144) (ok true))
(define-read-only (ping-150) (ok true))
(define-read-only (ping-196) (ok true))
(define-read-only (ping-217) (ok true))
(define-read-only (ping-225) (ok true))
